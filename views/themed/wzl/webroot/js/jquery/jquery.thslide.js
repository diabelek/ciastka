...
(function ($) {
	...
	var slideListPrevious = function (settings) {
		if (!settings.locked && settings.scrollOn == 1 && ((parseInt(settings.listMarginLeft) + parseInt(settings.itemOffset) <= 0) || settings.infiniteScroll == 1)) {
	...
	var slideListNext = function (settings) {
		if (!settings.locked && settings.scrollOn == 1 && (((parseInt(settings.listMarginLeft) - parseInt(settings.itemOffset)) >= settings.itemOffsetMax) || settings.infiniteScroll == 1)) {
			settings.locked = true;
